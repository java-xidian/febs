package com.mrbird.common.shiro;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.mrbird.common.config.FebsProperties;
import com.mrbird.common.listener.ShiroSessionListener;
...
public class ShiroConfig {
	...
	private RedisManager redisManager() {
		...
		// removed from shiro-redis v3.1.0 api
	...
	private SimpleCookie rememberMeCookie() {
		// 设置 cookie 名称，对应 login.html 页面的 <input type="checkbox"
		// name="rememberMe"/>
