package com.mrbird.job.service.impl;

import com.mrbird.common.annotation.CronTag;
import com.mrbird.common.service.impl.BaseService;
import com.mrbird.job.dao.JobMapper;
import com.mrbird.job.domain.Job;
import com.mrbird.job.service.JobService;
import com.mrbird.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.mrbird.job.task");
