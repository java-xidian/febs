package com.mrbird.system.controller;
...
import com.mrbird.common.util.vcode.Captcha;
import com.mrbird.common.util.vcode.GifCaptcha;
...
public class LoginController extends BaseController {
	...
	public void getGifCode(HttpServletResponse response, HttpServletRequest request) {
		try {
			...
			Captcha captcha = new GifCaptcha(febsProperties.getValidateCode().getWidth(),
					febsProperties.getValidateCode().getHeight(), febsProperties.getValidateCode().getLength());
